	...
	\begin{center}
		...
		\setlength{\@title@width}{6.5cm}
		{
			...
			\begin{spacing}{2.1}
				...
				%\xiaoer\hei{\qquad\qquad\quad} \xiaoer \hei\underline{\makebox[\@title@width][l]{（如需使用第二行）}} \\
				...
				\xiaosi\song{\makebox[\@title@width][l]{\qquad \qquad \qquad 2017 年 6 月}} \\
				%\end{tabular}
			\end{spacing}
		}
	\end{center}
